...
import com.example.managercouphone.databinding.ActivityKeypadPinBinding

class KeypadPinActivity : AppCompatActivity() {
    private lateinit var binding : ActivityKeypadPinBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityKeypadPinBinding.inflate(layoutInflater)
